...
# Arrow buttons widget
UP_ARROW_BIG = IMAGE_DIRECTORY / 'widget_icons' / 'big_up.png'
UP_ARROW_SMALL = IMAGE_DIRECTORY / 'widget_icons' / 'small_up.png'
DOWN_ARROW_BIG = IMAGE_DIRECTORY / 'widget_icons' / 'big_down.png'
DOWN_ARROW_SMALL = IMAGE_DIRECTORY / 'widget_icons' / 'small_down.png'