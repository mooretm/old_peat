...
class SessionDialog(tk.Toplevel):
    ...
    def __init__(self, parent, sessionpars, *args, **kwargs):
        ...
        # Step Sizes
        ttk.Label(frm_options, text="Step Sizes:"
        ...
        # ttk.Label(frm_options, text="Presentations:"
        ...
        # Starting Level
        ttk.Label(frm_options, text="Starting Level (dB):"
            ).grid(row=30, column=5, sticky='e', **widget_options)
        ttk.Entry(frm_options, width=20, 
        ...
        # Rapid Descend
        ttk.Label(frm_options, text="Rapid Descend:"
            ).grid(row=35, column=5, sticky='e', **widget_options)
        vlist = ["Yes", "No"]
        ttk.Combobox(
            frm_options, 
            ...
            values=vlist,
            state='readonly'
        ).grid(row=35, column=10, sticky='w')
